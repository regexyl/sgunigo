...
app = Flask(__name__)
<<<<<<< HEAD:microservices/sgunigo/applicant.py
app.config['SQLALCHEMY_DATABASE_URI'] = environ.get('dbURL') or 'mysql+mysqlconnector://root:root@localhost:3306/applicant_details'
=======
...
>>>>>>> new-microservices:Microservices/applicant/applicant.py
