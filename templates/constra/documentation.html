...
<head>
	<meta charset="UTF-8">
	<title>Constra Documentation</title>
	<!-- Fonts -->
...
<nav class="navbar main-nav fixed-top navbar-expand-lg">
  <div class="container">
      <a class="navbar-brand" href="#" >Constra Documentation</a>
      ...
      <ul class="navbar-nav ml-auto menu">
      	<li class="nav-item">
          <a class="nav-link" target="_blank" href="http://demo.themefisher.com/constra/">Demo</a>
        </li>
        <li class="nav-item">
	...
	<div class="container">
		<div class="row">
			<div class="col-12 text-center">
				<h1>Constra Documentation</h1>
				<h3>Last Update: 2/9/2019</h3>
				<p>We are constantly doing updates for you. Please check the online documentation.</p>
				<a href="https://docs.themefisher.com/constra/" class="btn btn-main-rounded">View Online Documentation</a>
			</div>
		</div>
	</div>
</section>
