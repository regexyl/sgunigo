          ...
          <div class="row">
              <div class="col-lg-8 col-md-8">
                <ul class="top-info text-center text-md-left">
                    <li><i class="fas fa-map-marker-alt"></i> <p class="info-text">80 Stamford Rd, Singapore 178902</p>
                    </li>
                </ul>
              </div>
              <!--/ Top info end -->
              ...
              <div class="col-lg-4 col-md-4 top-social text-center text-md-right">
                <ul class="list-unstyled">
                    <li>
                      <a title="Facebook" href="https://www.facebook.com/moesingapore/">
                          <span class="social-icon"><i class="fab fa-facebook-f"></i></span>
                      </a>
                      <a title="Twitter" href="https://twitter.com/MOEsg">
                          <span class="social-icon"><i class="fab fa-twitter"></i></span>
                      </a>
                      <a title="Instagram" href="https://www.instagram.com/moesingapore">
                          <span class="social-icon"><i class="fab fa-instagram"></i></span>
                      </a>
                      <a title="Linkdin" href="https://github.com/reginaliuyx/sgunigo">
                  ...
                  <li>
                    <div class="info-box">
                      <div class="info-box-content">
                          ...
                          <p class="info-box-subtitle">(+65) 6808 7960</p>
                      </div>
                    </div>
                  </li>
                  <li>
                    <div class="info-box">
                      <div class="info-box-content">
                          ...
                          <p class="info-box-subtitle">sgunigo@gov.edu.sg</p>
                      </div>
                    </div>
                  </li>
    ...
    <div class="row">
      <div class="col-12">
        <div class="shuffle-btn-group">
          ...
          <label for="sutd">
            <input type="radio" name="shuffle-filter" id="sutd" value="sutd">SUTD
          </label>
        ...
        <div class="row shuffle-wrapper">
          ...
          <div class="col-lg-4 col-md-6 shuffle-item" data-groups="[&quot;nus&quot;]">
            <div class="project-img-container">
              <a class="gallery-popup" href="../images/university/nus.jpg" aria-label="project-img">
                <img class="img-fluid" src="../images/university/nus.jpg" alt="project-img">
                <span class="gallery-icon"><i class="fa fa-plus"></i></span>
              </a>
              <div class="project-item-info">
                <div class="project-item-info-content">
                  <h3 class="project-item-title">NUS
                  </h3>
                  <p class="project-cat">National University of Singapore</p>
                </div>
              </div>
            </div>
          ...
          <div class="col-lg-4 col-md-6 shuffle-item" data-groups="[&quot;ntu&quot;]">
            <div class="project-img-container">
              <a class="gallery-popup" href="../images/university/ntu.jpg" aria-label="project-img">
                <img class="img-fluid" src="../images/university/ntu.jpg" alt="project-img">
                <span class="gallery-icon"><i class="fa fa-plus"></i></span>
              </a>
              <div class="project-item-info">
                <div class="project-item-info-content">
                  <h3 class="project-item-title">NTU
                  </h3>
                  <p class="project-cat">Nanyang Technological University</p>
                </div>
              </div>
            </div>
          ...
          <div class="col-lg-4 col-md-6 shuffle-item" data-groups="[&quot;smu&quot;]">
            <div class="project-img-container">
              <a class="gallery-popup" href="../images/university/smu.jpg" aria-label="project-img">
                <img class="img-fluid" src="../images/university/smu.jpg" alt="project-img">
                <span class="gallery-icon"><i class="fa fa-plus"></i></span>
              </a>
              <div class="project-item-info">
                <div class="project-item-info-content">
                  ...
                  <p class="project-cat">Singapore Management University</p>
                </div>
              </div>
            </div>
          ...
          <div class="col-lg-4 col-md-6 shuffle-item" data-groups="[&quot;sit&quot;]">
            <div class="project-img-container">
              <a class="gallery-popup" href="../images/university/sit.png" aria-label="project-img">
                <img class="img-fluid" src="../images/university/sit.png" alt="project-img">
                <span class="gallery-icon"><i class="fa fa-plus"></i></span>
              </a>
              <div class="project-item-info">
                <div class="project-item-info-content">
                  ...
                  <p class="project-cat">Singapore Institute of Technology</p>
                </div>
              </div>
            </div>
          ...
          <div class="col-lg-4 col-md-6 shuffle-item" data-groups="[&quot;suss&quot;]">
            <div class="project-img-container">
              <a class="gallery-popup" href="../images/university/suss.jpg" aria-label="project-img">
                <img class="img-fluid" src="../images/university/suss.jpg" alt="project-img">
                <span class="gallery-icon"><i class="fa fa-plus"></i></span>
              </a>
              <div class="project-item-info">
                <div class="project-item-info-content">
                  ...
                  <p class="project-cat">Singapore University of Social Sciences</p>
                </div>
              </div>
            </div>
          ...
          <div class="col-lg-4 col-md-6 shuffle-item" data-groups="[&quot;sutd&quot;]">
            <div class="project-img-container">
              <a class="gallery-popup" href="../images/university/sutd.jpg" aria-label="project-img">
                <img class="img-fluid" src="../images/university/sutd.jpg" alt="project-img">
                <span class="gallery-icon"><i class="fa fa-plus"></i></span>
              </a>
              <div class="project-item-info">
                <div class="project-item-info-content">
                  ...
                  <p class="project-cat">Singapore University of Technology and Design</p>
                </div>
              </div>
            </div>
        ...
        <div class="row justify-content-between">
          <div class="col-lg-4 col-md-6 footer-widget footer-about">
            ...
            <div class="footer-social">
              <ul>
                <li><a href="https://www.facebook.com/moesingapore/" aria-label="Facebook"><i
                      class="fab fa-facebook-f"></i></a></li>
                <li><a href="https://twitter.com/MOEsg" aria-label="Twitter"><i class="fab fa-twitter"></i></a>
                </li>
                <li><a href="https://www.instagram.com/moesingapore" aria-label="Instagram"><i
                      class="fab fa-instagram"></i></a></li>
                <li><a href="https://github.com/reginaliuyx/sgunigo" aria-label="Github"><i class="fab fa-github"></i></a></li>
              </ul>
